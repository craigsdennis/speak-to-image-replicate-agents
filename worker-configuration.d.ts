/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f0ff4397cdf3e2b9695a6cdeb0d4770)
// Runtime types generated with workerd@1.20251109.0 2025-11-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ImageAgent";
	}
	interface Env {
		REPLICATE_API_TOKEN: string;
		ImageAgent: DurableObjectNamespace<import("./worker/index").ImageAgent>;
		IMAGES: R2Bucket;
		AI: Ai;
		Storager: Workflow<Parameters<import("./worker/index").Storager['run']>[0]['payload']>;
	}
}
